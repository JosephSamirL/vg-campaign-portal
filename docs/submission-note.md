...
Contactable — Kilele **36,446** (caption: consent = true, blank = not consented; status ∉ {bounced, unsubscribed}; `suppressed_until` past; no ingested bounced / unsubscribed / complained event, seed or provider). Blank consent as "no" and seed events as suppressions are rule choices; either alternative shows ~51,298. Runner-up: KIL-0016 open rate 119.16 % (total opens ÷ sent, unclamped).
